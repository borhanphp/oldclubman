            ...
            return (
              <div key={user.id || index} className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <Link href={`/user/user-profile/${user?.id}`}>
                      <p className="text-sm hover:underline font-semibold text-gray-900 truncate">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`px-3 py-1 text-xs font-medium rounded-full transition-colors min-w-[70px] ${
                    isFollowed
