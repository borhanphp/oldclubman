...
import { FaGift, FaArrowLeft, FaCheckCircle, FaCreditCard, FaSpinner } from 'react-icons/fa';
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="border-b border-gray-200 p-6">
            <div className="flex items-center">
              <button
                onClick={() => router.back()}
                className="text-blue-500 mr-4 hover:text-blue-600 transition-colors"
              >
                <FaArrowLeft className="text-xl" />
              </button>
              <div className="flex items-center">
                <FaGift className="text-purple-600 text-3xl mr-3" />
                <div>
                  <h1 className="text-2xl font-bold text-gray-800">Purchase Gift Card</h1>
                  <p className="text-sm text-gray-600 mt-1">Add funds to your wallet instantly</p>
                </div>
              </div>
            </div>
          </div>
